...
################################################################
# This is a generated script based on design: adder_2bit
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set A [ create_bd_port -dir I -from 1 -to 0 -type data A ]
  set B [ create_bd_port -dir I -from 1 -to 0 -type data B ]
  set Sum [ create_bd_port -dir O -from 2 -to 0 -type data Sum ]
  ...
  connect_bd_net -net A_1 [get_bd_ports A] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din]
  connect_bd_net -net B_1 [get_bd_ports B] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din]
  ...
  connect_bd_net -net FA_1_Cout [get_bd_pins FA_1/Cout] [get_bd_pins xlconcat_0/In2]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins FA_0/Cin] [get_bd_pins xlconstant_0/dout]
  ...
  connect_bd_net -net xlslice_2_Dout [get_bd_pins FA_0/B] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins FA_1/B] [get_bd_pins xlslice_3/Dout]
