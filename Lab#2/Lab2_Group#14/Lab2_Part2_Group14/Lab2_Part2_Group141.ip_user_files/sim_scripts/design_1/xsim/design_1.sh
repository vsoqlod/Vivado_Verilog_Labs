...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L xlslice_v1_0_2 -L util_vector_logic_v2_0_1 -L xlconcat_v2_1_4 -L unisims_ver -L unimacro_ver -L secureip --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xlslice_v1_0_2 util_vector_logic_v2_0_1 xlconcat_v2_1_4)
